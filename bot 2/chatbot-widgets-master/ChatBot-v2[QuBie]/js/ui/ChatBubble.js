...
var Bubble = function(obj_utterance, bubble_type){
    ...
    let _message = obj_utterance.getDialogUtterance().replace(/</g, "&lt;").replace(/>/g, "&gt;");
    ...
    var _template_common = `
        <div id="dialog-${_date.valueOf()}" class="container ">
            <div class=" ${dialog_direction} card ${bg_color} text-light justify-content-around align-items-center shadow">
                <span id=${obj_utterance.getUserId()+'-'+_date.valueOf()} class=" card-body text-sm-center">
